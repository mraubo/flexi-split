...
7. Dodaj akcję „Usuń” (DELETE) z modalem potwierdzenia, obsługą 204/404/403/422 i natychmiastową aktualizacją listy.
8. Zaimplementuj puste stany z CTA i mobilną dostępnością, zgodnie z WCAG AA.
9. Dodaj paginację/„Załaduj więcej” z łączeniem stron i kontrolą limitu do 100, bez naruszania kolejności.
